...
| `showDialCode`           | `boolean`                                                          | `false`                                                               | Automatically prepend the country dial code (e.g., +1) to the phone input. Changing the country clears the phone input and sets the new dial code. Validation errors are not triggered when the input is empty or contains only the dial code. When false, the phone input remains empty and clears on country change. |
