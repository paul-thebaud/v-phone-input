...
const props = withDefaults(defineProps<VPhoneInputProps>(), {
  ...
  phoneValidator: (): any => getOption('phoneValidator'),
  countryIconMode: (): any => getOption('countryIconMode'),
  allCountries: (): any => getOption('allCountries'),
  preferCountries: (): any => getOption('preferCountries'),
  includeCountries: (): any => getOption('includeCountries'),
  excludeCountries: (): any => getOption('excludeCountries'),
  defaultCountry: (): any => getOption('defaultCountry'),
  countryGuesser: (): any => getOption('countryGuesser'),
  guessCountry: (): any => getOption('guessCountry'),
  disableGuessLoading: (): any => getOption('disableGuessLoading'),
  enableSearchingCountry: (): any => getOption('enableSearchingCountry'),
  displayFormat: (): any => getOption('displayFormat'),
  country: '',
  modelValue: '',
  wrapperProps: () => ({}),
  countryProps: () => ({}),
